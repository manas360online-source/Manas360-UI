        ...
        <div className="bg-white dark:bg-[#1E293B] rounded-[32px] p-8 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.05)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-[#E0F2FE] dark:border-slate-800 transition-colors">
          <div className="flex gap-4 mb-5">
            <div className="flex-1">
              <label className="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-2 ml-1">First name</label>
              <input 
                type="text" 
                value={firstName}
            ...
            <div className="flex-1">
              <label className="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-2 ml-1">Last name</label>
              <input 
                type="text" 
                value={lastName}
          ...
          <div className="mb-10">
            <label className="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-2 ml-1">Pronouns (optional)</label>
            <input 
              type="text" 
              value={pronouns}
