...
export const OnboardingEmail: React.FC<OnboardingEmailProps> = ({ userName }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#E9F5FF] to-white dark:from-slate-900 dark:to-slate-950 p-6 animate-fade-in transition-colors duration-500">
      
      <div className="w-full max-w-md">
        <h1 className="font-serif text-[2.5rem] font-bold text-[#0A3A78] dark:text-white text-center mb-4 transition-colors">
          Nice to meet you, <span className="text-[#1E59FF] dark:text-sky-400">{userName || 'friend'}</span>.
        </h1>
        ...
        <div className="bg-white dark:bg-[#1E293B] rounded-[32px] p-8 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.05)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-[#E0F2FE] dark:border-slate-800 transition-colors">
          ...
          <div className="mb-6">
            <label className="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-2 ml-1">Email Address</label>
            <input 
              type="email" 
              value={email}
          ...
          <div className="flex items-start gap-3 mb-10">
             ...
             <p className="text-sm text-slate-500 dark:text-slate-400 leading-tight pt-1">
               I agree to the <a href="#" className="text-[#1E59FF] dark:text-sky-400 font-bold">Terms of Service</a> and <a href="#" className="text-[#1E59FF] dark:text-sky-400 font-bold">Privacy Policy</a>.
             </p>
          </div>
